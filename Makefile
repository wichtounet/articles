...
$(eval $(call folder_compile,/linear_sorting))
$(eval $(call folder_compile,/threads/benchmark))
$(eval $(call folder_compile,/threads/part1))
$(eval $(call folder_compile,/threads/part2))
...
$(eval $(call add_executable,threads_p1_hello2,threads/part1/Hello2.cpp))

$(eval $(call add_executable,threads_p2_counter1,threads/part2/Unsafe.cpp))
$(eval $(call add_executable,threads_p2_counter2,threads/part2/Safe.cpp))
$(eval $(call add_executable,threads_p2_counter3,threads/part2/Exception.cpp))
$(eval $(call add_executable,threads_p2_counter4,threads/part2/SafeGuard.cpp))

$(eval $(call add_executable,threads_p3_recursive,threads/part3/recursive_problem.cpp))
$(eval $(call add_executable,threads_p3_recursive2,threads/part3/recursive_mutex.cpp))
$(eval $(call add_executable,threads_p3_timed,threads/part3/timed_mutex.cpp))
$(eval $(call add_executable,threads_p3_call_once,threads/part3/call_once.cpp))
$(eval $(call add_executable,threads_p3_condition_variables,threads/part3/condition_variables.cpp))

$(eval $(call add_executable,threads_p4_atomic_counter,threads/part4/AtomicCounter.cpp))

$(eval $(call add_executable,threads_bench,threads/benchmark/bench.cpp))

$(eval $(call add_executable,linear_sorting,linear_sorting/bench.cpp))

$(eval $(call add_executable,boost_po_v1,boost_po/v1.cpp,-lboost_program_options))

$(eval $(call add_executable,vector_list,vector_list/bench.cpp graphs.cpp demangle.cpp))

$(eval $(call add_executable,intrusive_list,intrusive_list/bench.cpp graphs.cpp demangle.cpp))
